                        ...
                        {questions.map((q, i) => (
                            <div key={`manage-q-${i}`} className="p-3 bg-theme-card border border-border-main rounded-xl relative group transition-colors">
                                ...
                                <div className="grid grid-cols-2 gap-1.5">
                                    {q.options.map((o, oi) => (
                                        <div key={`manage-q-${i}-opt-${oi}`} className={`text-[9px] font-bold px-2 py-1 rounded ${oi === q.correctAnswerIndex ? 'bg-green-100 text-green-700' : 'bg-hover-bg text-text-muted'}`}>
                                            {o}
                                        </div>
                                    ))}
                                </div>
