                ...
                >
                    ...
                    <div className="flex gap-2">
                        <button 
                            ...
                            className="flex-grow py-4 bg-primary text-white rounded-2xl font-bold text-xs tracking-wide active:scale-[0.98] transition-all shadow-lg shadow-primary/20"
                        >
                            Confirm rating
                        </button>
                        <button 
